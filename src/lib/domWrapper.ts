...
//El1 = change to, EL2 optional change from
export function change(SCC: styleChangeConfiguration, container: HTMLElement, el1: HTMLElement, el2?: HTMLElement) {
    ...
    if (SCC.fade == true) {
        ...
        el1.style.transition = "opacity " + SCC.fadeTime + "ms linear"
        if (SCC.fromInvis == true) {
            setTimeout(() => {
                //This means the image is already in DOM
                el1.style.visibility = "initial"
                el1.style.opacity = "1"
